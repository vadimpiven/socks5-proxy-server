...
// The rule-set system was removed in favour of per-user [User.AllowPrivate]:
// the only meaningful policy distinction for a SOCKS5 proxy is whether
// private/internal destinations are reachable.
package socks5
